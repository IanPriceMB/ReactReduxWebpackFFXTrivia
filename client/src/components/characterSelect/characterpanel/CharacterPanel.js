    ...
    <div className='characterPanel' >
      <div className='characterPanel__media'>
        ...
        <img className='characterPanel__media__picture'
          src={ props.character == 'Tidus' ? Tidus: 
          ...
          props.character == 'Kimahri' ? Kimahri: null} 
          alt={props.character} />
      </div>
      <div className='info'>
        <h2 className='characterPanel__info__subtitle'>{characterData[props.character].strength.name}</h2>
        <p className='characterPanel__info__discription'>{characterData[props.character].strength.discription}</p>
        <h2 className='characterPanel__info__subtitle'>{characterData[props.character].weakness.name}</h2>
        <p className='characterPanel__info__discription'>{characterData[props.character].weakness.discription}</p>
      </div>
    </div>
  )
